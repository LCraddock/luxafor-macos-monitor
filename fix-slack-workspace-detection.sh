#!/usr/bin/env bash
#
# fix-slack-workspace-detection.sh
# Fix the Slack workspace detection bug where multi-workspace notifications are disabled
#

echo "🔧 Fixing Slack workspace detection bug..."

# Backup the current file
cp /Users/larry.craddock/Projects/luxafor/luxafor-notify.sh /Users/larry.craddock/Projects/luxafor/luxafor-notify.sh.backup

echo "✅ Backup created: luxafor-notify.sh.backup"

# Create the fixed version
cat > /Users/larry.craddock/Projects/luxafor/luxafor-notify-fixed.sh << 'EOF'
#!/usr/bin/env bash
#
# luxafor-notify.sh
...
echo "✅ Created fixed version: luxafor-notify-fixed.sh"
echo ""
echo "🔍 Key changes made:"
echo "   • Added original_badge_count variable to preserve dock badge"
echo "   • Fixed logic to never set badge_count=0 when dock badge exists"  
echo "   • Added fallback for unknown Slack notifications"
echo "   • Enhanced debug logging for troubleshooting"
echo ""
echo "Would you like to:"
echo "1. Review the fixed code first"
echo "2. Deploy the fix immediately"
echo "3. Test the fix with debug logging"

read -p "Enter your choice (1/2/3): " choice

case $choice in
    1)
        echo "Opening fixed file for review..."
        ;;
    2)
        echo "🚀 Deploying fix..."
        cp /Users/larry.craddock/Projects/luxafor/luxafor-notify-fixed.sh /Users/larry.craddock/Projects/luxafor/luxafor-notify.sh
        echo "✅ Fix deployed! Restarting service..."
        pkill -f luxafor-notify
        echo "✅ Service restarted. Please test with a multi-workspace Slack notification."
        ;;
    3)
        echo "🧪 Testing mode - check /tmp/luxafor-debug.log for detailed logs"
        cp /Users/larry.craddock/Projects/luxafor/luxafor-notify-fixed.sh /Users/larry.craddock/Projects/luxafor/luxafor-notify.sh
        pkill -f luxafor-notify
        echo "✅ Fix deployed with debug logging enabled."
        ;;
esac
